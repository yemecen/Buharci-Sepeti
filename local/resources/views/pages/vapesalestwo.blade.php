...
@section('content')
		...
		<div class="row">
	        <div class="col-sm-6 col-sm-offset-3">
	            <div id="imaginary_container"> 
	            	<form  action='VapeSalesTwo' method='post'/>
	            	{!! csrf_field() !!}
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<nav aria-label="...">
			 	 <ul class="pager">
				    <li class="previous"><a href="{{ $sales->previousPageUrl() }}"><span aria-hidden="true">&larr;</span> Eski</a></li>
				    <li class="next"><a href="{{ $sales->nextPageUrl() }}">Yeni<span aria-hidden="true">&rarr;</span></a></li>
				 </ul>
				</nav>
			</div>
		</div>
	...
	<div class="text-center">
		<span class="label label-info">Sayfa {{ $sales->currentPage() }}</span>
	</div>
